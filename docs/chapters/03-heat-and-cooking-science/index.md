---
title: "Chapter 3: Heat, Cooking Science, and Chemical Reactions"
description: Explore how heat transforms food through conduction, convection, and radiation, and discover the chemical reactions that create color, flavor, and texture during cooking.
...
This chapter answers one of food science's most fundamental questions: what actually
happens to food when you cook it? Students explore the three modes of heat transfer
(conduction, convection, radiation), then follow the heat into the food itself —
denaturing proteins, gelatinizing starches, triggering the Maillard reaction and
caramelization, and driving oxidation and browning reactions. The chapter closes with
specialized cooking techniques including pressure cooking, microwave heating, and
emulsification, building the foundation for baking science in Chapter 5.
...
2. Conduction in Cooking
3. Convection in Cooking
4. Radiation in Cooking
5. Protein Denaturation by Heat
6. Starch Gelatinization
7. Maillard Reaction
8. Caramelization
9. Boiling Point and Altitude
10. Specific Heat Capacity of Food
11. Thermal Conductivity of Foods
12. Internal Cooking Temperature
13. Enzymatic Browning
14. Oxidation in Food
15. Smoke Point of Cooking Fats
16. Pressure Cooking Science
17. Microwave Heating Mechanism
18. Emulsification in Cooking
...
!!! mascot-welcome "Welcome to Chapter 3, Chef-Scientist!"
...
<details markdown="1">
<summary>Interactive Heat Transfer Explorer</summary>
...
!!! mascot-thinking "Zyme Thinks: Which Mode Are You Using?"
...
<details markdown="1">
<summary>Interactive Browning Reaction Comparison</summary>
Type: microsim
...
!!! mascot-tip "Zyme's Tip: The Thermometer Is Your Best Friend"
    <img src="../../img/mascot/tip.png" class="mascot-admonition-img" alt="Zyme giving a helpful tip">
...
!!! mascot-warning "Zyme's Warning: Smoke Means Stop!"
...
<details markdown="1">
<summary>Heat Penetration Comparison MicroSim</summary>
Type: microsim
...
!!! mascot-thinking "Zyme Wonders: What Makes a Great Emulsifier?"
    <img src="../../img/mascot/thinking.png" class="mascot-admonition-img" alt="Zyme with goggles thinking hard">
...
1. **Butter in the pan melts** — fat liquefies as heat energy disrupts its solid crystal structure
2. **Pan conducts heat to bread surface** — conduction transfers energy from metal to bread
3. **Bread surface reaches 280°F+** — Maillard reaction begins; hundreds of aroma and flavor compounds form; bread turns golden brown
4. **Bread proteins and starches transform** — proteins denature, starches gelatinize slightly, creating a firm crust
5. **Cheese heats from below** — proteins in cheese denature and the fat melts, creating that stretchy texture
6. **Crust forms** — outer bread moisture evaporates (steam) and the surface dries, setting the crust
...
<details markdown="1">
<summary>Grilled Cheese Cooking Science Interactive Timeline</summary>
Type: interactive-infographic
