---
title: "Chapter 13: The Farm-to-Table Movement and Local Food Systems"
description: Examine the science behind local food systems — nutrient loss during long-distance transport, the barriers that keep local food from reaching local consumers, and the community solutions that are rebuilding shorter, more nutritious food supply chains.
...
2. Global Food Distribution Networks
3. Long Supply Chain Effects on Freshness
4. Cold Chain Logistics
5. Nutrient Loss During Transport
6. Farmers Market Science
7. Community Supported Agriculture
8. Farm-to-School Programs
9. Urban Agriculture Overview
10. Rooftop and Vertical Farming
11. Community Gardens
12. Food Desert Definition
13. Food Access and Equity
14. Local Food Economic Impact
15. Local Sourcing in Schools
16. NOVA Classification and Ultra-Processed Foods
17. Whole Food vs. Processed Alternatives
18. Food Sovereignty Concepts
19. Carbon Footprint of Diet
20. Food System Resilience
...
!!! mascot-welcome "Welcome to the Farm-to-Table Movement!"
    <img src="../../img/mascot/welcome.png" class="mascot-admonition-img" alt="Zyme waving welcome">
    Science is delicious — and in this chapter, we follow the science of what happens to food during its journey from the farmer's field to your school cafeteria. Spoiler: the longer and more complicated that journey, the less nutritious and more expensive the food often becomes. But communities all over the world are finding creative scientific solutions to this problem. Let's bubble up some local food system thinking!
...
2. Harvested mechanically when still green (to survive transport without bruising)
3. Packed in a field packing house and loaded onto refrigerated trucks
4. Transported to a regional distribution center (often 500–2,000 miles away)
5. Sorted and repackaged at the distribution center
6. Transported by refrigerated truck to a regional warehouse
7. Delivered to individual store distribution centers
8. Delivered to retail stores
9. Displayed on a grocery shelf for 3–7 days
10. Purchased and transported home by the consumer
...
!!! mascot-thinking "Zyme Thinks: Why Does a Farmer's Market Strawberry Taste Different?"
...
!!! mascot-encourage "Zyme Encourages Systems Thinking"
    <img src="../../img/mascot/encouraging.png" class="mascot-admonition-img" alt="Zyme looking encouraging">
    Food systems are complex. Local food isn't always more nutritious. Organic isn't always better for the environment. Longer supply chains aren't always bad — they've helped reduce hunger globally. The key is developing the scientific and economic literacy to evaluate specific claims rather than accepting simple slogans in either direction. "Buy local" is a good starting point for thinking — not a complete answer.
