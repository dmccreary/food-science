---
title: "Chapter 9: Food Preservation — Extending Shelf Life Through Science"
description: Discover the science behind every major food preservation method — from canning and freezing to fermentation and modified atmosphere packaging — and understand why each method works at the molecular level.
...
2. Water Activity in Preservation
3. Canning and Heat Sterilization
4. Botulism and Canning Safety
5. Fermentation as Preservation
6. Salt and Osmosis in Preservation
7. Pickling Chemistry
8. Dehydration and Drying Methods
9. Freeze-Drying Science
10. Freezing and Ice Crystal Formation
11. Blanching Before Freezing
12. Smoking and Curing
13. Modified Atmosphere Packaging
14. Food Irradiation
15. Food Additives and Preservatives
...
**How heat sterilization works:**
- At temperatures above 140°F (60°C), most vegetative bacteria die rapidly
- At 212°F (100°C) — boiling — most bacteria are killed, but **bacterial spores** are not
- At 240–250°F (116–121°C) — achieved only in a **pressure canner** — bacterial spores are destroyed
...
1. Salt dissolves in the water surrounding food
2. The high concentration of salt outside microbial cells creates an osmotic pressure gradient
3. Water moves out of bacterial cells toward the high-salt exterior
4. Bacteria lose so much water they cannot function — they are effectively dehydrated and killed or inhibited
...
1. Food is frozen solid at very low temperatures (−40°F to −80°F)
2. The frozen food is placed in a vacuum chamber at very low pressure
3. At low pressure, ice converts directly from solid to vapor without melting — a process called **sublimation**
4. The water vapor is removed, leaving behind a dry, porous food structure
...
<details markdown="1">
<summary>Ice Crystal Formation Simulator</summary>
Type: microsim
...
**Smoking** preserves food through three mechanisms:
1. **Heat** — hot smoking (160–180°F) partially cooks the surface
2. **Drying** — the hot dry smoke reduces surface water activity
3. **Antimicrobial compounds** — wood smoke contains phenols, formaldehyde, acetic acid, and other compounds that are deposited on the food surface and inhibit microbial growth
...
MAP is used for:
- Fresh-cut produce in "salad bags" (typically 5% O₂, 10% CO₂, 85% N₂)
- Fresh pasta, meat, and seafood
- Potato chips (nitrogen flush prevents rancidity without changing flavor)
