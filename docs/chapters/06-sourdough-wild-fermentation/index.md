---
title: "Chapter 6: Sourdough and Wild Fermentation"
description: Explore the living microbial ecosystem inside a sourdough starter — capturing wild yeast, feeding the culture, and controlling temperature and hydration to shape the final loaf's flavor.
...
1. Wild Yeast Capture
2. Sourdough Starter Ecosystem
3. Sourdough Lactic Acid Bacteria
4. Sourdough Feeding Ratio
5. Sourdough Starter Float Test
6. Sourdough Temperature Effects
7. Lactic Acid Production
8. Acetic Acid Production
9. Bulk Fermentation
...
- [Chapter 5: Baking Science](../05-baking-science/index.md)

---

!!! mascot-welcome "Welcome to the Wildest Chapter in This Book!"
    <img src="../../img/mascot/welcome.png" class="mascot-admonition-img" alt="Zyme waving welcome">
    Science is delicious — and sourdough is living proof! I, Zyme, am literally a yeast cell of the type you'll be capturing in this chapter. Humans have been harvesting wild yeast from the air and flour for at least 6,000 years. Now you're going to do it too. Let's bubble up some answers!
...
The basic procedure:
1. Mix equal weights of whole-wheat flour and unchlorinated water in a clean jar
2. Cover loosely (allows gas exchange, prevents contamination)
3. Leave at room temperature (68–75°F / 20–24°C) for 24 hours
4. Discard half and add fresh flour and water (this is called "feeding")
5. Repeat daily for 7–14 days, observing daily changes
...
!!! mascot-thinking "Zyme Thinks: How Do Yeast and Bacteria Share a Jar?"
    <img src="../../img/mascot/thinking.png" class="mascot-admonition-img" alt="Zyme thinking with goggles">
    In a commercial yeast packet, you get one pure strain. In a sourdough starter, you get dozens of microbial species competing and cooperating at the same time. The yeast tend to dominate numerically during the active rise phase; the bacteria are often 100× more numerous overall. Each feeding resets the competition by providing fresh food (flour), and the community re-establishes its balance within a few hours. I find this deeply beautiful.
...
1. **Acid control** — as the starter ferments, it accumulates lactic and acetic acid that lower the pH progressively. If you never discard, the pH drops so low that it inhibits even the acid-tolerant wild yeast
2. **Volume management** — without discarding, the starter would double in size with each feeding and quickly overflow any container
...
1. Immediately after feeding: flat, dense — sinks (fails float test)
2. Hours 2–4: begins to rise as yeast ferment, producing CO₂
3. Hours 4–8 (warm conditions): reaches peak — domed top, maximum rise — floats!
4. Hours 8–12: begins to fall as food runs out, acid builds up
5. Hours 12–24: collapsed back to near original volume — sinks again (time to feed)

#### Diagram: Sourdough Rise-and-Fall Cycle Simulation

<details markdown="1">
<summary>Sourdough Starter Activity Tracker MicroSim</summary>
Type: microsim
...
A typical bulk fermentation timeline at 75°F:
- Hours 0–1: Yeast begin activating; little visible change
- Hours 1–3: Dough becomes noticeably airy and jiggly; bubbles visible at the surface
- Hours 3–5: Dough volume increases 50–75%; dough feels light and passes the poke test (indentation slowly springs back)
- Hours 5+: If pushed too far, the dough becomes over-fermented — sticky, very acidic, with collapsed gluten structure
