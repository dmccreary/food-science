# Learning Graph for Food Science for 9th Grade
...
- Foundational concepts: 25 entry points
...
- Category organization — foundational skills first, engineering and innovation last
- Balanced categories (4.3%–11.5% each)
- All categories under 30% threshold
- Pedagogical flow recommendations
- Clear 4–5 letter abbreviations for use in CSV file
